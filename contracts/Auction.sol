...
contract Auction {
    ...
    // Optional: helper to fetch all auctions (for frontend)
    function getAllAuctions() external view returns (DomainAuction[] memory) {
        DomainAuction[] memory result = new DomainAuction[](nextAuctionId);
